...
public class ChessMatch {
	...
	private void validateSourcePosition(Position position) {
		if(!board.thereIsAPiece(position)) {
			throw new ChessException("Nao há nenhuma peça na posiçao de origem");
		}
	...
	private void validateTargetPosition(Position source, Position target) {
		if (!board.piece(source).possibleMove(target)) {
			throw new ChessException("A peça escolhida nao pode se mover para a posiçao de destino");
		}
	}
	...
	private ChessPiece king(Color color) {
		...
		throw new IllegalStateException("Nao existe nenhum rei da cor " + color + " no tabuleiro");
	}
